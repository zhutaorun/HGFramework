...
function LuaSceneMgr.EnterScene(loadingSceneName, self1, loadingDoneCallback, sceneName, logicResNames, self2, loadDoneCallback, loadUpdateCallback)
...
function LuaSceneMgr.GetResObj(resName)
